...
// Create Sakura instance to cover the entire webpage
var sakura = new Sakura('body', {
  fallSpeed: 2, // You can adjust the fall speed as needed
  maxSize: 20, // You can adjust the maximum size of petals
  minSize: 15, // You can adjust the minimum size of petals
  delay: 200, // You can adjust the delay between petals
  colors: [
